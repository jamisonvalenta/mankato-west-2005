...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-gray-200 p-6 text-gray-300  lg:justify-center lg:p-8">
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                ...
                <template v-else>
                    <Link
                        :href="route('login')"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-gray-300 hover:border-gray-300 "
                    >
                        Log in
                    </Link>
                    <Link
                        :href="route('register')"
                        class="inline-block rounded-sm border border-gray-300 px-5 py-1.5 text-sm leading-normal text-gray-300 hover:border-gray-200 "
                    >
                        Register
                    </Link>
                </template>
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full flex-col overflow-hidden rounded-lg lg:max-w-6xl lg:flex-row">
                <div
                    class="flex-1 rounded-bl-lg rounded-br-lg bg-white p-6 pb-12 leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)]  lg:rounded-br-none lg:rounded-tl-lg lg:p-10"
                >
                    <h1 class="text-gray-700 mb-4 text-xl font-semibold">Welcome Mankato West Class of 2005!</h1>
                    <p class="mb-2 text-gray-800 text-base">
                        This is your one-stop-shop for all things reunion!
                    </p>


                    <h2 class="text-gray-700 mt-12 mb-4 text-lg font-semibold">
                        Tentative Schedule
                    </h2>
                    <dl class="grid grid-cols-[6em,1fr] md:grid-cols-[10em,1fr] gap-2 text-gray-700 text-base">
